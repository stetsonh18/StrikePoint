    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-4 p-4 bg-slate-800/50 border border-slate-700 rounded-xl">
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-900 border border-slate-700 rounded-lg text-slate-100 text-sm focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
            >
              {expirations.map((exp) => (
        ...
        <div>
          ...
          <select
            ...
            className="px-4 py-2 bg-slate-900 border border-slate-700 rounded-lg text-slate-100 text-sm focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
          >
        ...
        {/* Strike Search */}
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">Strike Search</label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="150.00"
              className="w-32 pl-10 pr-4 py-2 bg-slate-900 border border-slate-700 rounded-lg text-slate-100 text-sm focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
            />
          </div>
        </div>
      </div>
      ...
      {chainData.underlying_price && (
        <div className="text-center text-sm text-slate-400">
          Underlying Price: <span className="text-slate-100 font-semibold">{formatCurrency(chainData.underlying_price)}</span>
        </div>
      )}
    </div>
  );
