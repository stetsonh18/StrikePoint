          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-800/50 placeholder-slate-500 text-slate-200 bg-slate-900/50 rounded-t-md focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 focus:z-10 sm:text-sm transition-all"
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-800/50 placeholder-slate-500 text-slate-200 bg-slate-900/50 rounded-b-md focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 focus:z-10 sm:text-sm transition-all"
