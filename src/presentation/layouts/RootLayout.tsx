...
export const RootLayout = () => {
  ...
  return (
    <div className="h-screen flex bg-slate-50 dark:bg-slate-950 relative overflow-hidden">
      ...
      <Sidebar />
      <div className="relative flex-1 flex flex-col overflow-hidden w-full min-w-0 left-0">
        <Header />
        <main id="main-content" className="flex-1 overflow-auto px-3 md:px-6 py-3 md:py-6 w-full" tabIndex={-1} style={{ marginLeft: 0 }}>
          <Outlet />
        </main>
      </div>
    </div>
